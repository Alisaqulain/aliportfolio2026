  ...
  return (
    <Section id="contact" className="bg-surface/40 pt-28">
      ...
      <Reveal delay={0.15} className="mt-8 space-y-3 font-mono text-sm text-muted">
        <p className="inline-flex items-center gap-2"><Mail size={14} /> {SITE.email}</p>
        <p className="inline-flex items-center gap-2"><Phone size={14} /> {SITE.phone}</p>
        <button type="button" onClick={copyEmail} className="inline-flex items-center gap-2 text-muted hover:text-foreground">
